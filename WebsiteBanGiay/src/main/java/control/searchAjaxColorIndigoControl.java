...
@WebServlet(name = "searchAjaxColorIndigoControl", urlPatterns = {"/searchAjaxColorIndigo"})
public class searchAjaxColorIndigoControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        List<Product> list = dao.searchColorIndigo();
