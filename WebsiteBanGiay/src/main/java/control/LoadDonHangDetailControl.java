...
@WebServlet(name = "LoadDonHangDetailControl", urlPatterns = {"/loadDonHangDetail"})
public class LoadDonHangDetailControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        for (OrderDetail o : ListOrder) {
				if ( id.equals(String.valueOf(o.getOrderID()))) {
					p.setName(o.getName());
