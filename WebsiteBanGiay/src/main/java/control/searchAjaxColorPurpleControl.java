...
@WebServlet(name = "searchAjaxColorPurpleControl", urlPatterns = {"/searchAjaxColorPurple"})
public class searchAjaxColorPurpleControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        List<Product> list = dao.searchColorPurple();
