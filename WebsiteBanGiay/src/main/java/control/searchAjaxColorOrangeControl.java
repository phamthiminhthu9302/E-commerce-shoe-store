...
@WebServlet(name = "searchAjaxColorOrangeControl", urlPatterns = {"/searchAjaxColorOrange"})
public class searchAjaxColorOrangeControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        List<Product> list = dao.searchColorOrange();
