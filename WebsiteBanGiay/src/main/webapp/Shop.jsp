              ...
              <section class="mb-4">
                ...
                <div class="btn-group btn-group-toggle btn-color-group d-block mt-n2 ml-n2" data-toggle="buttons">
                  ...
                  <label class="btn rounded-circle purple p-3 m-2">
                    <input onchange="searchByColorPurple()" type="checkbox" autocomplete="off">
                  </label>
                  ...
                  <label class="btn rounded-circle indigo p-3 m-2">
                    <input onchange="searchByColorIndigo()"type="checkbox" checked autocomplete="off">
                  </label>
                  <label class="btn rounded-circle red p-3 m-2">
                    <input onchange="searchByColorRed()" type="checkbox" autocomplete="off">
                  </label>
...
<c:if test="${o.count == 0}">
                  <div class="view zoom overlay rounded z-depth-2">
                    <img class="img-fluid w-100"   style="height:200px;"
                      src="${pageContext.request.contextPath }/images/${o.image }" alt="Sample">
                    <a href="detail?pid=${o.id}">
                     <h4 class="mb-0"><span class="badge badge-primary badge-pill badge-news">Sold out</span></h4>
                      <div class="mask">
                        <img class="img-fluid w-100"
                          src="${pageContext.request.contextPath }/images/${o.image }">
                           <h4 class="mb-0"><span class="badge badge-primary badge-pill badge-news ">Sold out</span></h4>
                  ...
                  <div class="text-center pt-4">
                    ...
                    <h5>${o.name }
                    <p></h5><span class="mr-1"><strong>${o.price }$</strong></span></p>
...
<div class="view zoom overlay rounded z-depth-2">
  ...
  <script>
    ...
    function searchByColorBlack(){
        ...
        $.ajax({
            url: "/WebsiteBanGiay/searchAjaxColorGreen",
            type: "get", //send it through get method
            data: {
    ...
    function searchByColorBlue(){
        $.ajax({
            url: "/WebsiteBanGiay/searchAjaxColorBlue",
            type: "get", //send it through get method
            data: {
    ...
    function searchByColorPurple(){
        $.ajax({
            url: "/WebsiteBanGiay/searchAjaxColorPurple",
            type: "get", //send it through get method
            data: {
    ...
    function searchByColorIndigo(){
        $.ajax({
            url: "/WebsiteBanGiay/searchAjaxColorIndigo",
            type: "get", //send it through get method
            data: {
    ...
    function searchByColorRed(){
        $.ajax({
            url: "/WebsiteBanGiay/searchAjaxColorRed",
            type: "get", //send it through get method
            data: {
    ...
    function searchByColorOrange(){
        $.ajax({
            url: "/WebsiteBanGiay/searchAjaxColorOrange",
            type: "get", //send it through get method
            data: {
