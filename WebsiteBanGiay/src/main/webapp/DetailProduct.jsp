	...
	<main>
				...
				<div class="row">
								...
								<div class="col-12 mb-0">
									<figure class="view overlay rounded z-depth-1 main-img"
										...
										<a
											...
											src="${pageContext.request.contextPath }/images/${detail.image}"
											class="img-fluid z-depth-1" style="margin-top: -90px;">
										</a>
										<c:if test="${detail.count == 0}">
											<h4 class="mb-0">
												<span class="badge badge-primary badge-pill badge-news">Sold
													out</span>
											</h4>
										</c:if>
                  ...
                  <figure class="view overlay rounded z-depth-1" style="visibility: hidden;">
					...
					<div class="col-md-6">
						...
						<p>
							<span><strong>${detail.price }$</strong></span>
						</p>
						...
						<c:if test="${detail.count != 0}">
							...
							<div class="form-check form-check-inline pl-0">
								<input type="radio" class="form-check-input" id="small"
									value="Small" name="size" required> <label
									class="form-check-label small text-uppercase card-link-secondary"
									for="small">Small</label>
							</div>
							...
							<div class="form-check form-check-inline pl-0">
								<input type="radio" class="form-check-input" id="medium"
									value="Medium" name="size" required> <label
									class="form-check-label small text-uppercase card-link-secondary"
									for="medium">Medium</label>
							</div>
							<%
							...
							<div class="form-check form-check-inline pl-0">
								<input type="radio" class="form-check-input" id="large"
									value="Large" name="size" required> <label
									class="form-check-label small text-uppercase card-link-secondary"
									for="large">Large</label>
							</div>
							<%
		...
		<section class="text-center">
			...
			<div class="row">
						...
						<div class="">
							...
							<div class="view zoom overlay z-depth-2 rounded">
								<img class="img-fluid w-100" style="height: 200px;"
									...
									alt="Sample"> <a href="detail?pid=${o.id}"> <c:if
										test="${o.count == 0}">
										<h4 class="mb-0">
											<span class="badge badge-primary badge-pill badge-news">Sold
												out</span>
                ...
                <h5>${o.title }</h5>
                <p><span
                    class="text-grey"><strong>${o.price }$</strong></span></p>
