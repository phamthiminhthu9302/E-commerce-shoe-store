            ...
            <form class="form-signin" action="login" method="post">
              <c:if test="${error!=null }">
                ...
                <button class="btn btn-success btn-block" type="submit"><i class="fas fa-sign-in-alt"></i> Sign in</button>
                 <a class="nav-link btn " href="forgotPassword">Forgot Password?</a>
               
                <hr>

                <a href="Register.jsp"><button class="btn btn-primary btn-block" type="button" id="btn-signup"><i class="fas fa-user-plus"></i> Sign up New Account</button></a>
            </form>
