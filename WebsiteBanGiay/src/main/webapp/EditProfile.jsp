...
<div id="logreg-forms">
            ...
            <a href="home"><button type="button" class="close"  data-dismiss="modal"
                ...
                <input name="username" type="text" id="username" class="form-control" value="${sessionScope.acc.user.trim()}" required="" autofocus="">
                <label for="password">Password</label>
                <input name="password" type="password" id="password" class="form-control" value="${sessionScope.acc.pass.trim()}" required="" autofocus="">
