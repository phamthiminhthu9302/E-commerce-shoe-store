                                             ...
                                             <c:forEach items="${listProduct}" var="p">
                                                ...
                                                <tr>
													...
													<div class="ml-2 align-middle">
														<img src="${pageContext.request.contextPath }/images/${p.image}" alt="Card image cap"> <br>
														<h7 class="mb-0">${p.name}</h7>
                     ...
                     <td class="align-middle">
                     	<strong>${o.size}</strong>
                                    ...
                                    <div>  <% if(count==0){ %>
                                               ...
                                               <h3 style="padding-left:450px;">Chưa có sản phẩm</h3>
                        ...
                        <div class="row py-2 p-4 bg-white rounded shadow-sm">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="p-4">
                                    ...
                                    </ul><%if(count==0 ){%><a href="#" class="btn btn-dark rounded-pill py-2 btn-block text-white">Thanh Toán</a><%}else{ %>
                                   <a href="DatHang.jsp" class="btn btn-dark rounded-pill py-2 btn-block text-white">Thanh Toán</a><%} %>
                                </div>
                            </div>
                        </div>
