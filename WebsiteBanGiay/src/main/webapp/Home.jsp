...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"> 
 ...
 <!-- Carousel wrapper -->
  ...
  <div class="card" style="border-style: none;">
    <img style="height:55px; width:64px; margin: auto;" src="${pageContext.request.contextPath }/images/images.png">
    <div class="card-body">
  ...
  <div class="card" style="border-style: none;">
    <img class="card-img-top" style="height:55px; width:64px; margin: auto;" src="${pageContext.request.contextPath }/images/pngtree-payment-icon-png-image_1842637.jpg" alt="Card image cap">
    <div class="card-body">
  ...
  <div class="card" style="border-style: none;">
    <img class="card-img-top" style="height:55px; width:64px; margin: auto;" src="${pageContext.request.contextPath }/images/pngtree-warranty-line-icon-good-for-presentation-png-image_3016749.png" alt="Card image cap">
    <div class="card-body">
  ...
  <div class="card" style="border-style: none;">
    <img class="card-img-top" style="height:55px; width:64px; margin: auto;" src="${pageContext.request.contextPath }/images/Icon-Doi-Tra-Hang.jpg" alt="Card image cap">
    <div class="card-body">
                        ...
                        <c:forEach items="${list8Last}" var="o">
                            <div class=" col-12 col-md-6 col-lg-3" style="padding-top:10px;">
                                ...
                                <div class="view zoom z-depth-2 rounded">
                                    <img class="img-fluid w-100" style="height:200px;"src="${pageContext.request.contextPath }/images/${o.image}" alt="Card image cap">
                                    <c:if test="${o.count == 0}">
                                    <h4 class="mb-0"><span class="badge badge-primary badge-pill badge-news">Sold out</span></h4>
                                    </c:if>
                                     </div>
                                    <div class="card-body">
